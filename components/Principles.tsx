...
const forbidden = [
  {
    num: '01',
    text: 'Не начинаем с кода. Начинаем с археологии процесса. Не готовы потратить 30 минут на аудит — мы не ваш проводник.',
  },
  {
    num: '02',
...
const notFit = [
  ...
  'Думаете, что автоматизация починит хаос без археологии',
]
