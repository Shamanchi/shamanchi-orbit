...
const plans = [
  ...
  },
  {
    ...
    price: 'от 25 000 ₽',
    note: '3–7 дней',
    desc: 'Одна восстановленная орбита: от археологии до документации. Код, тесты, деплой.',
    features: [
      'Археология и проектирование потока',
      'Код, тесты, деплой',
  ...
  },
  {
    ...
    price: 'от 90 000 ₽',
    note: 'от 3 недель',
    desc: 'Система из нескольких орбит. Рост без новых узких мест — заложен на 10x.',
    features: [
