...
export const metadata: Metadata = {
  ...
  description:
    'Большинство бизнесов управляют процессами, которых не существует. Мы находим скрытые орбиты и запускаем их. Архитектура процесса, одна точка рычага, автоматизация без хаоса. Аудит — 30 минут.',
  keywords: [
    'shamanchi orbit',
    ...
    '@graph': [
      ...
      },
      {
        ...
        mainEntity: [
          ...
          {
            '@type': 'Question',
            name: 'Чем автоматизация без архитектуры опасна',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Автоматизация хаотичного процесса закрепляет хаос в коде. Сначала проектируем процесс, потом строим систему.',
            },
          },
          {
            '@type': 'Question',
      ...
      },
      {
        ...
        description: 'Пять шагов от архитектуры процесса до роста без новых узких мест.',
        step: [
          {
            '@type': 'HowToStep',
            name: 'Архитектура',
